          ...
          <div className="main-container">
            <div id="scrollContainer" className="flex-container container ">
               ...
               <img className="bg-img" src={AnsonBackground} alt="Background with a portrait of Anson" />
                <div className="spacer-sm"></div>
                  ...
                  <div className="col-md-12">
                    ...
                    <p>
                        Hi, I'm <span className="b"> Anson Li</span>. I'm currently out and about, working as a software developer at ATB. When I'm not busy learning the ins and outs of React and NodeJS development, I dedicate my learning to full-stack development, scripting languages, and coffee culture.
                        <br /><br />
              ...
              <div className="flex-container container">
                ...
                <div className="spacer-sm"></div>
                <div className="spacer-sm"></div>
                <div className="col-md-12 fixed-bottom"></div>
              </div>
            </div>
          </div>
        <div id="bottom"></div>
